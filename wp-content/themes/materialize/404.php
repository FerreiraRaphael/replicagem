            ...
            <div class="row">
                ...
                <section class="col s12">
                    ...
                    <div>
                        ...
                        <big class="error-404-message"><?php _e( 'Recurso não encontrado' , 'materialize' )?></big>
                        <p class="error-404-description"><?php _e( 'Infelizmente esta pagina, post ou recurso não existe ou não foi encontrado :(' , 'materialize' ) ?></p>
