 ...
 */
    ...
    if ( $total > 1 )  {
        ...
        $pagination = array(
            ...
            'mid_size'      => 2,
            'prev_next'     => true,
            'prev_text'     => sprintf( __( '%s Anterior' , 'materialize' ) , '<i class="mythemes-icon-left-open-1"></i>' ),
            'next_text'     => sprintf( __( 'Proximo %s' , 'materialize' ) , '<i class="mythemes-icon-right-open-1"></i>' ),
            'type'          => 'list',
            'add_args'      => false,
            'add_fragment'
        );
