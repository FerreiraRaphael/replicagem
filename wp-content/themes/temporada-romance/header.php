...
<body <?php body_class(); ?>>
    ...
    <?php
            ...
            <header class="<?php echo esc_attr( $mythemes_header_class ); ?>">
                ...
                <!-- header navigation -->
                <nav class="gradient mythemes-topper" role="navigation">
                    <div class="nav-wrapper container">
                        ...
                        //Fucking CSS Cat http://codepen.io/Lospolloshermanos/pen/cikrs
                        echo'
                        <div id="gato">
                            <div class="orelha">
                          ...
                          <div class="cabeca">
                              <div class="olhos"></div>
                              <div class="nariz">
                                  <div class="nariz-right">
                                    <div></div>
                                    <div></div>
                                    <div></div>
                                </div>
                                <div class="nariz-left">
                                    <div></div>
                                    <div></div>
                                    <div></div>
                                </div>
